---
description: Rebase with master, verify migration ordering, then open a DRAFT PR with templated description
---

# spartan-draft-pr

Open a **draft** PR for current branch. Three guards before push:
...
- Tell user: "Rebase conflict on N files. Resolve manually, then `git rebase --continue` and re-run /spartan-draft-pr."
- Exit.
...
Return draft PR URL. Remind user to mark "Ready for review" when done.
